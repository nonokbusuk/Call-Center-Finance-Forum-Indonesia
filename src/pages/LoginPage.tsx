    ...
    <div className="min-h-screen bg-gradient-to-br from-finance-navy to-finance-navy/80 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          />
          <h1 className="text-2xl font-bold text-white">call-center.id</h1>
          <p className="text-gray-300">Forum Keuangan Indonesia</p>
        </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-center">
              Masukkan email dan password untuk mengakses forum
            </CardDescription>
          </CardHeader>
          <CardContent>
